...
C
C     A. Aguado, C. Suárez, M. Paniagua, J. Chem. Phys. 101(1994) 4004-4010.
C
...
************************************************************************
  ...
  772 format(1x,i3,7x,4(f10.5,3x))
      cal1=rms
      return
      end
************************************************************************
...
************************************************************************
     ...
     ,emax*bfact
  772 format(1x,i3,7x,5(f10.5,3x))
      cal2=rms
      return
      end
************************************************************************
...
************************************************************************
  ...
  772 format(1x,i3,7x,6(f10.5,3x))
      cal3=rms
      return
      end
************************************************************************
...
************************************************************************
  ...
  772 format(1x,i3,7x,7(f10.5,3x))
      cal4=rms
      return
      end
************************************************************************
...
************************************************************************
  ...
  772 format(1x,i3,7x,9(f10.5,3x))
      cal6=rms
      return
      end
************************************************************************
...
**********************************************************************
      ...
      implicit real*8(a-h,o-z)
      print*,' Sorry: subroutine in proyect'
      stop
      end
**********************************************************************
...
****************************************************************
 ...
 3010 format(72('*'),/,6x,'subroutine ',a6,'(r,ener,der,iop)',/,
     ...
     -72('*'),/,
     -6x,'implicit real*8 (a-h,o-z)',/,
     -6x,'parameter(mt=',i3,',e0=',d14.7,')',/,
     -6x,'parameter(vex1=',d22.12,',vex2=',d22.12,')',/,
     -6x,'dimension cf(mt)')

      do 17 k=1,mt
         write(7,3012) k,sm(k)
   17 continue
 3012 format(6x,'data cf(',i3,')/',d22.12,'/')
