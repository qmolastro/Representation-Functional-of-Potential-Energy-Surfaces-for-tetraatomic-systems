...
************************************************************************
      implicit real*8 (a-h,o-z)
      parameter(mt=  6)
      parameter(e0= 0.0000000D+00)
      parameter(vex1=  0.165794595000000D+01)
      parameter(vex2=  0.192681240000000D+01)
      dimension cf(mt)
      data cf(  1)/  0.100582864185162D+01/
      data cf(  2)/ -0.328787241355486D+01/
      data cf(  3)/  0.270836301221307D+02/
      data cf(  4)/ -0.180246256517823D+03/
      data cf(  5)/  0.647540308481217D+03/
      data cf(  6)/ -0.933018533257344D+03/
      der = 0.d0
      aux = 1.d0/r
      bux = dexp(-vex2*r)*aux
      cux = dexp(-vex1*r)
...
*************************************************************
      ...
      parameter(vex1=  0.156190000000000D+00)                             
      parameter(vex2=  0.150000100000000D+01)                             
      parameter(vex3=  0.124744700000000D+01)                             
      dimension der(3)                                       
      ...
      data cf(  1)/  0.379652668089365D+02/
      data i1(  1)/ 0/,i2(  1)/ 1/,i3(  1)/ 1/
      data cf(  2)/  0.109161179953039D+01/
      data i1(  2)/ 1/,i2(  2)/ 0/,i3(  2)/ 1/
      data cf(  3)/  0.647458872024840D+01/
      data i1(  3)/ 1/,i2(  3)/ 1/,i3(  3)/ 0/
      data cf(  4)/ -0.122207741460411D+03/
      data i1(  4)/ 0/,i2(  4)/ 1/,i3(  4)/ 2/
      data cf(  5)/ -0.126473537977168D+03/
      data i1(  5)/ 0/,i2(  5)/ 2/,i3(  5)/ 1/
      data cf(  6)/  0.277415510727258D+02/
      data i1(  6)/ 1/,i2(  6)/ 0/,i3(  6)/ 2/
      data cf(  7)/ -0.828077993379461D+02/
      data i1(  7)/ 1/,i2(  7)/ 1/,i3(  7)/ 1/
      data cf(  8)/ -0.365242295453587D+01/
      data i1(  8)/ 1/,i2(  8)/ 2/,i3(  8)/ 0/
      data cf(  9)/ -0.876852493490055D+00/
      data i1(  9)/ 2/,i2(  9)/ 0/,i3(  9)/ 1/
      data cf( 10)/ -0.835290191933228D+01/
      data i1( 10)/ 2/,i2( 10)/ 1/,i3( 10)/ 0/
      data cf( 11)/  0.694723171102089D+03/
      data i1( 11)/ 0/,i2( 11)/ 1/,i3( 11)/ 3/
      data cf( 12)/ -0.802353835651328D+03/
      data i1( 12)/ 0/,i2( 12)/ 2/,i3( 12)/ 2/
      data cf( 13)/  0.959983210876907D+03/
      data i1( 13)/ 0/,i2( 13)/ 3/,i3( 13)/ 1/
      data cf( 14)/ -0.127052191212682D+03/
      data i1( 14)/ 1/,i2( 14)/ 0/,i3( 14)/ 3/
      data cf( 15)/  0.158644333845204D+03/
      data i1( 15)/ 1/,i2( 15)/ 1/,i3( 15)/ 2/
      data cf( 16)/  0.209256144232285D+03/
      data i1( 16)/ 1/,i2( 16)/ 2/,i3( 16)/ 1/
      data cf( 17)/ -0.112445084994891D+03/
      data i1( 17)/ 1/,i2( 17)/ 3/,i3( 17)/ 0/
      data cf( 18)/ -0.216564410044886D+02/
      data i1( 18)/ 2/,i2( 18)/ 0/,i3( 18)/ 2/
      data cf( 19)/  0.615761512276759D+02/
      data i1( 19)/ 2/,i2( 19)/ 1/,i3( 19)/ 1/
      data cf( 20)/  0.103847737925012D+02/
      data i1( 20)/ 2/,i2( 20)/ 2/,i3( 20)/ 0/
      data cf( 21)/  0.223268094402404D+00/
      data i1( 21)/ 3/,i2( 21)/ 0/,i3( 21)/ 1/
      data cf( 22)/  0.464511223351139D+01/
      data i1( 22)/ 3/,i2( 22)/ 1/,i3( 22)/ 0/
      data cf( 23)/ -0.258801534845160D+03/
      data i1( 23)/ 0/,i2( 23)/ 1/,i3( 23)/ 4/
      data cf( 24)/ -0.169242354541205D+04/
      data i1( 24)/ 0/,i2( 24)/ 2/,i3( 24)/ 3/
      data cf( 25)/  0.306755920001146D+04/
      data i1( 25)/ 0/,i2( 25)/ 3/,i3( 25)/ 2/
      data cf( 26)/ -0.237466134143187D+04/
      data i1( 26)/ 0/,i2( 26)/ 4/,i3( 26)/ 1/
      data cf( 27)/  0.324207797105399D+02/
      data i1( 27)/ 1/,i2( 27)/ 0/,i3( 27)/ 4/
      data cf( 28)/  0.151708332766791D+03/
      data i1( 28)/ 1/,i2( 28)/ 1/,i3( 28)/ 3/
      data cf( 29)/ -0.177820056390011D+03/
      data i1( 29)/ 1/,i2( 29)/ 2/,i3( 29)/ 2/
      data cf( 30)/ -0.304686678991268D+03/
      data i1( 30)/ 1/,i2( 30)/ 3/,i3( 30)/ 1/
      data cf( 31)/  0.228158098368283D+03/
      data i1( 31)/ 1/,i2( 31)/ 4/,i3( 31)/ 0/
      data cf( 32)/  0.411570815013755D+02/
      data i1( 32)/ 2/,i2( 32)/ 0/,i3( 32)/ 3/
      data cf( 33)/ -0.454749485385867D+02/
      data i1( 33)/ 2/,i2( 33)/ 1/,i3( 33)/ 2/
      data cf( 34)/ -0.981048969166849D+02/
      data i1( 34)/ 2/,i2( 34)/ 2/,i3( 34)/ 1/
      data cf( 35)/  0.423301056809707D+02/
      data i1( 35)/ 2/,i2( 35)/ 3/,i3( 35)/ 0/
      data cf( 36)/  0.554900277613473D+01/
      data i1( 36)/ 3/,i2( 36)/ 0/,i3( 36)/ 2/
      data cf( 37)/ -0.134271735247783D+02/
      data i1( 37)/ 3/,i2( 37)/ 1/,i3( 37)/ 1/
      data cf( 38)/ -0.639347965902081D+01/
      data i1( 38)/ 3/,i2( 38)/ 2/,i3( 38)/ 0/
      data cf( 39)/  0.157063047025008D-02/
      data i1( 39)/ 4/,i2( 39)/ 0/,i3( 39)/ 1/
      data cf( 40)/ -0.946258930769429D+00/
...
*************************************************************
     ...
     ,            f23(-1:mt_2),f24(-1:mt_2),f34(-1:mt_2)     
      data vex6(1)/  0.484131000000000D+00/                               
      data vex6(2)/  0.753610000000000D-01/                               
      data vex6(3)/  0.153391452120544D+00/                               
      data vex6(4)/  0.108619100000000D+01/                               
      data vex6(5)/  0.104325017226444D+01/                               
      data vex6(6)/  0.141360000000000D+01/                               
